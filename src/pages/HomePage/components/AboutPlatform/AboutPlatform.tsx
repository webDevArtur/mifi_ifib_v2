  ...
  return (
    <div className={styles.platformInfo}>
      ...
      <p className={styles.platformInfoDescription}>
        Эта платформа для будущих и практикующих медицинских физиков
        предоставляет комплексные возможности для эффективного обучения.
      </p>

      <p className={styles.platformInfoDescription}>
        Это пространство для всестороннего профессионального развития, где
        традиционные методы образования сочетаются с инновационными
        интерактивными подходами.
      </p>
      ...
      <div className={styles.platformInfoFeatures}>
        ...
        <div className={styles.platformInfoFeature}>
          ...
          <p className={styles.platformInfoFeatureDescription}>
            Погружение в медицинскую физику с помощью «Базы знаний»
          </p>
        </div>
        ...
        <div className={styles.platformInfoFeature}>
          ...
          <p className={styles.platformInfoFeatureDescription}>
            Прохождение интерактивных квестов для закрепления теоретических и
