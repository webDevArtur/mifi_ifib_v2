  ...
  return (
    <div className={styles.container}>
      <div className={styles.breadcrumb}>
        <Link to="/">Главная</Link> / <Link to="/introduction">Введение в медицинскую физику</Link> /  <Link to="/video-lectures">Видеолекции</Link> / 
      </div>

      <h1>Основы позитронно-эмиссионной томографии (ПЭТ): Принципы и Применение</h1>
