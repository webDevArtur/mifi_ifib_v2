...
export const getEquipments = (
  ...
  const url = `v1/nuclear-medicine-intro/equipment?page=${page}&pageSize=${size}${searchQuery}${equipmentGroupQuery}${idsQuery}`;
...
export const getEquipmentGroups = () => {
  const url = 'v1/nuclear-medicine-intro/equipment/groups/';
