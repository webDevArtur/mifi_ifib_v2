...
export const getQuestTasks = (
  ...
  const url = `https://medphysicists-stage.ru/api/v1/quests/tasks/?${questQuery}${orderNumQuery}${pageQuery}${sizeQuery}`;
...
interface SubmitQuestTaskRequest {
  ...
  export const submitQuestTask = (
    ...
    const url = `https://medphysicists-stage.ru/api/v1/quests/tasks/${questTaskId}/submit/`;
