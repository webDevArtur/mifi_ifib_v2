...
import { ProgressStatisticsResponseSchema } from "./progressStatisticsResponse";
...
export type ProgressStatisticsResponse = z.infer<
  typeof ProgressStatisticsResponseSchema
>;
